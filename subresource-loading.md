...
After the initial version of resource preloading, more flexible mechanisms could be layered on top of it to fulfil additional goals and provide more control to developers.
...
No version is currently spelled out which is known to meet all goals completely, which is why this is still a work in progress.
